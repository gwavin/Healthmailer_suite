...
internal sealed class InstallForm : Form
{
    ...
    private void ShowReviewStep()
    {
        ...
        TableLayoutPanel layout = CreateBaseLayout("Ready to install", "Review the watched handoff folder before installing HealthMailer.");
    ...
    private void InstallClicked(object? sender, EventArgs e)
    {
        ...
        catch (Exception ex)
        {
            ...
            MessageBox.Show(this, ex.Message, "HealthMailer install failed", MessageBoxButtons.OK, MessageBoxIcon.Error);
        }
        finally
        {
            SetBusy(false);
