...
internal static class InstallerBranding
{
    ...
    {
        string iconPath = Path.Combine(InstallerPaths.PayloadAssetsRoot, "branding", "mncms.ico");
        ...
        string imagePath = Path.Combine(InstallerPaths.PayloadAssetsRoot, "branding", "mncms_400x400.jpg");
